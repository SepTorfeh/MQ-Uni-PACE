    ...
    return (
        <div className="landing-page">
            ...
            <div className="landing-title">
                ...
                <div className="right animated fadeInUp delay-2">We'll ask you a few questions to get to know you better!</div>
                <div className="right animated fadeInUp delay-4"><button type="button" className="button green-button" onClick={() => nextPage()} tabIndex={-1}>Fire away!</button></div>
            </div>
